...
<!-- JSP 모듈 파일 임포트  -->
<c:import url="../NDiaryContent/detail.jsp" var="detailcontent"></c:import>
<c:import url="../NDiaryContent/write.jsp" var="writecontent"></c:import>
<c:import url="../NDiaryContent/modify.jsp" var="modifycontent"></c:import>
<c:import url="../NDiaryContent/delete.jsp" var="deletecontent"></c:import>
<!-- 파라미터에 따른 제목 설정 -->
<c:choose>
...
<title>MyDiary(Web) Calendar Mode | ${titlename} </title>
 <style>
	.footer{
		text-align: right;
		color: white; 
...
<div class= "col-lg-8" style="padding: 0px; margin: 70px; background-color: #DCDCDC; ">
    <h3 class="htitle">
    MyDiary(Web) Calendar Mode (Current User: ${sessionScope.id} ) ${titlename} 
    </h3>
