...
<table class="table table-striped" style="border:1px solid">
 ...
 <tr>
  ...
  <td><input type="text" name="product_name" value="${sessionScope.productdetaillist['product_name']}" required /></td>
 </tr>
 <tr>
  <td><label for="buy_date">구매 날짜(신품): </label></td>
  <td><input type="text" name="buy_date" value="${sessionScope.productdetaillist['buy_date']}" /></td>
 </tr>
 <tr>
  <td><label for="buy_date_used">구매 날짜(중고): </label></td>
  <td><input type="text" name="buy_date_used" value="${sessionScope.productdetaillist['buy_date_used']}" /></td>
 </tr>
 <tr>
  <td><label for="purpose">용도: </label></td>
  <td><input type="text" name="purpose" value="${sessionScope.productdetaillist['purpose']}" /></td>
 </tr>
</table>
<hr>
