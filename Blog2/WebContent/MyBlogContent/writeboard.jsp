         ...
         <div class="row" >
             <div class="col-sm-12" style="background-color: lightyellow; padding: 0px; margin: 0px">
                <h2 class="htitle" style="padding: 0px; margin: 0px;">Write Board</h2> 
                     ...
                     <tr>
                     <td><p><label for="user" style="font-size: 1.5em">User ID:</label></td><td><input type="text" class="form-control mr-sm-10" name="id" value='${sessionScope.id}' readonly  /></p></td>
                     <tr>
                     <td><p><label for="content" style="font-size: 1.5em">Content:</label></p></td>
                     <td><p><textarea class="form-control mr-sm-10" rows="20" cols="100" autofocus name="content" wrap="hard" ></textarea></p></td>
                     </tr>
                     <tr>
                     <td><p><label for="anonymous" style="font-size: 1.5em">Choose Access Mode</label></p></td>
